...
pub fn collect_instruction_fns(items: &[syn::Item]) -> Vec<syn::ItemFn> {
    items
        .iter()
...
pub fn read_spel_extension_attr(crate_dir: &Path) -> Option<String> {
...
pub fn read_spel_instruction_attrs(crate_dir: &Path) -> Vec<String> {
